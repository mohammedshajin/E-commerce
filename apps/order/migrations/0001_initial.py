# Generated by Django 3.2.3 on 2021-05-29 06:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sellers', models.ManyToManyField(related_name='orders', to='user.Buyer')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='user.buyer')),
            ],
        ),
    ]
